...
- Canonical repo target: `kotlin-random`. Useful entrypoints: `dev project show kotlin-random`, `dev build kotlin-random`, `dev check kotlin-random`.
- Setup-managed files are regenerated with `dev setup kotlin-random`; avoid hand-editing stamped generated files.
