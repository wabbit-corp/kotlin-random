...
// managed-integrity-v1: CsmKFvA6jC5
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-random", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-random")
        description.set("Kotlin Multiplatform deterministic random generators with mutable and serializable immutable states.")
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-random"
